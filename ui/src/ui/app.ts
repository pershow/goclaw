...
export class OpenClawApp extends LitElement {
  ...
  @state() accessor assistantName = injectedAssistantIdentity.name;
  @state() accessor assistantAvatar = injectedAssistantIdentity.avatar;
  @state() accessor assistantAgentId = injectedAssistantIdentity.agentId ?? null;
